...
router.post("/",async (req,res)=>{
    ...
    const{productId,quantity,category,collections,guestId,userId}=req.body;
    try{
...
router.put("/",async(req,res)=>{
    ...
    const {productId,quantity,collections,category,guestId,userId}=req.body;
    try{
            let cart=await getCart(userId,guestId);
...
router.delete("/", async (req, res) => {
    const { productId, collections, category, userId, guestId } = req.body;
